; This file is generated by the header generation tool. It lists all of the
; classes that are defined in the game, to allow any script to reference them.
;
; You may create classes that aren't in this list in your script. If you do,
; you do not need to add them to this list.
